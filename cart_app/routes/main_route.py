...
def add_price_data():
	...
	for row in df.values:
		n_product = Product(name=row[0], itemcode=row[1], kindname=row[2], unit=row[4], price=row[6],
							day_bf_price=row[7], week_bf_price=row[8], two_week_bf_price=row[9], month_bf_price=row[10])
